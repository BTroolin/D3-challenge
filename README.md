...
* Data are stored in the data.csv file and read by app.js to create the plots.

* Clicking axis labels switches the active values, allowing for nine different comparison plots.

* The points in the plot display detailed data on mouseover.

* Analyses of trends that stand out when examining the data are displayed below the scatter plot.
